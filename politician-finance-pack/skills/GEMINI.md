...
**Directory:** `politician-finance-pack/skills`

## Architectural Purpose
This directory (`skills`) is part of the overarching `government` intelligence repository. Its primary purpose is determined by the files contained within it.

## Directory Contents
**Subdirectories:** None
**Files:** member-tracking-rag-admin.md, campaign-finance-ingestion-admin.md, financial-disclosure-ingestion-admin.md, politician-masterdata-admin.md
