...
**Directory:** `politician-finance-pack/docs`

## Architectural Purpose
This directory (`docs`) is part of the overarching `government` intelligence repository. Its primary purpose is determined by the files contained within it.

## Directory Contents
**Subdirectories:** None
**Files:** source-notes.md
