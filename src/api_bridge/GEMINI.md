...
**Directory:** `src/api_bridge`

## Architectural Purpose
This directory (`api_bridge`) is part of the overarching `government` intelligence repository. Its primary purpose is determined by the files contained within it.
