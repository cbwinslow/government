...
**Directory:** `src/dashboard/src/components`

## Architectural Purpose
This directory (`components`) is part of the overarching `government` intelligence repository. Its primary purpose is determined by the files contained within it.

## Directory Contents
**Subdirectories:** None
**Files:** NetworkDashboard.tsx, PoliticianProfile.tsx, NetworkGraph.tsx
