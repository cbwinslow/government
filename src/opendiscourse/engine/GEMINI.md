...
**Directory:** `src/opendiscourse/engine`

## Architectural Purpose
This directory (`engine`) is part of the overarching `government` intelligence repository. Its primary purpose is determined by the files contained within it.

## Directory Contents
**Subdirectories:** None
**Files:** llm_factory.py, scorer.py
