...
**Directory:** `src/opendiscourse/mcp`

## Architectural Purpose
This directory (`mcp`) is part of the overarching `government` intelligence repository. Its primary purpose is determined by the files contained within it.
