...
**Directory:** `src/opendiscourse/core`

## Architectural Purpose
This directory (`core`) is part of the overarching `government` intelligence repository. Its primary purpose is determined by the files contained within it.

## Directory Contents
**Subdirectories:** None
**Files:** db_client.py, config.py, haystack_retriever.py, interfaces.py
