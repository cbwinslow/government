...
**Directory:** `gov-skills/configs`

## Architectural Purpose
This directory (`configs`) is part of the overarching `government` intelligence repository. Its primary purpose is determined by the files contained within it.

## Directory Contents
**Subdirectories:** None
**Files:** vscode-tasks.json, .env.example, claude-desktop-mcp.json, vscode-launch.json, mcp-servers.json
