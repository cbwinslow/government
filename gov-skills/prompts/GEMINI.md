...
**Directory:** `gov-skills/prompts`

## Architectural Purpose
This directory (`prompts`) is part of the overarching `government` intelligence repository. Its primary purpose is determined by the files contained within it.

## Directory Contents
**Subdirectories:** None
**Files:** honesty-engine-prompts.md, ingestion-admin-prompts.md, vscode-prompts.md
