...
**Directory:** `gov-skills/orchestration`

## Architectural Purpose
This directory (`orchestration`) is part of the overarching `government` intelligence repository. Its primary purpose is determined by the files contained within it.

## Directory Contents
**Subdirectories:** prompts
**Files:** master-delegation-protocol.md
