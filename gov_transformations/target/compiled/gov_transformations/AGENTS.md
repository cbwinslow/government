...
**Target Directory:** `gov_transformations/target/compiled/gov_transformations`
...
```yaml
system_prompt: >
  You are operating within 'gov_transformations'. Your primary objective is to execute 
