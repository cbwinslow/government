...
**Directory:** `gov_transformations/target/compiled/gov_transformations/models`

## Architectural Purpose
This directory (`models`) is part of the overarching `government` intelligence repository. Its primary purpose is determined by the files contained within it.

## Directory Contents
**Subdirectories:** None
**Files:** epstein_overlap.sql
